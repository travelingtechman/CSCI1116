...
public class SierpinskiTrangle extends Application {
  private int order = 1;
  ...
  public void start(Stage primaryStage) {       
    ...
    plus.setOnAction(e -> trianglePane.setOrder(order++));
    Button minus = new Button("-");
    minus.setAlignment(Pos.BOTTOM_CENTER);
    minus.setOnAction(e -> {if(trianglePane.getOrder(order) > 0) { trianglePane.setOrder(order--);}
    else {} });
    //tfOrder.setOnAction(
